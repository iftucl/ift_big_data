...
from modules.db_ops.duckdb_client import DuckDBMinioReader
...
def get_aggregated_trades(
    ...
    :param business_date: a string representation of datetime object as 'YYYYMMDD'
    ...
    :rtype: list[dict]
    """
    full_path = "s3:/" + dl_path + "/" + file_name + f"{business_date}*.csv"
    ...
    aggregated_df = duck_client.read_csv(path=full_path, custom_query=custom_query)
