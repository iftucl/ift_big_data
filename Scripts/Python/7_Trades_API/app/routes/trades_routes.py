...
from app.api_models.api_requests.trades_requests import AllTradesRequest, TraderTradesRequest, CreateTrade
from app.api_models.api_responses.trade_model import Trade
from app.modules.mongodb_trades_get import TradeQuery, TradeInsert
...
async def post_trader_trade_endpoint(trader_id: Annotated[str, Path(description="Get all trades by trader", title="Trader Trades", example="SML1458")],
    ...
    lambro_logger.info(f"Executing request query to crate a new trade for {trader_id} TradingRecord collection")
